...
const ViewToggler: React.FC<ViewTogglerProps> = ({ onLogout, activeTab, setActiveTab }) => {
  return (
    <div className="flex mt-2 font-mulish justify-between items-center">
      ...
      <div onClick={onLogout} className="cursor-pointer font-semibold text-sm px-3 py-2 h-5/6 rounded-xl border-2 border-[#7B1984] border-opacity-15 bg-baseColor flex justify-evenly items-center">
